...
Console.WriteLine($"O horista {retorno.horista} trabalhou {retorno.horasTotais}h, sendo {retorno.horas}h normais, {retorno.horasSabado}h a 50% e {retorno.horasDomingo} a 100% totaliando {retorno.horasEfetivas}h efetivas sendo consideradas {retorno.horasPagar}h a pagar e {retorno.horasBanco}h como banco de horas. Com o valor hora de R$ {retorno.valorHora} a remuneração final é de {retorno.remuneracaoSemanal}, o valor sera depositado no {retorno.diaUtil}º dia util.");
